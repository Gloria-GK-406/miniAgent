import { z } from "zod";
import { AgentContextProvider } from "../tool/agent-context.js";
import { bashTool } from "../tool/bash.js";
import { editTool } from "../tool/edit.js";
import { globTool } from "../tool/glob.js";
import { grepTool } from "../tool/grep.js";
import { McpPlugin } from "../tool/mcp/plugin.js";
import { McpPluginConfigSchema, type McpPluginConfigInput } from "../tool/mcp/types.js";
import { readTool } from "../tool/read.js";
import { SkillPlugin } from "../tool/skill/plugin.js";
import { SkillPluginConfigSchema, type SkillPluginConfigInput } from "../tool/skill/types.js";
import {
    SubagentPlugin,
...
export function registerBuiltinBlueprintImpls(
    ...
    manager.registerApprovalImpl("allow-all", {
        configSchema: EmptyConfigSchema,
        create: () => ({
            requestApproval: async (_toolName: string, _args: Record<string, unknown>) => true,
        }),
    });
