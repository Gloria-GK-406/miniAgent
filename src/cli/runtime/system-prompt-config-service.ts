...
export const SystemPromptConfigServiceSchema = createProtocolSchema({
  setSystemPrompt: createFunctionSchema<(prompt: string) => Promise<CLIConfig>>(),
  unsetSystemPrompt: createFunctionSchema<() => Promise<CLIConfig>>(),
});
