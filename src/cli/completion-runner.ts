...
const COMPLETION_OPTIONS: CompletionOption[] = [
  ...
  { long: "--config-paths", description: "Print resolved config file paths" },
  { long: "--show-config", description: "Print merged runtime config" },
  { long: "--init", description: "Create a project config template" },
  ...
  { long: "--prompt-file", description: "Read the initial prompt from a file. Use - to read stdin" },
