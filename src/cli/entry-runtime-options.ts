...
export async function applyCLIEntryRuntimeOptions(
  ...
  action: Extract<CLIEntryAction, { type: "tui" | "print" | "doctor" | "status" | "overview" | "list-tools" | "list-agents" | "preview-context" | "show-history" | "list-snapshots" | "snapshot-action" }>,
): Promise<void> {
