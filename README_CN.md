...
CLI shell service 执行。项目自定义命令可以放在 `.cliagent/commands/*.md`；
...
- 新增命令：`/git [status|log]`、`/diff [path]`、`/editor [initial text]`、`/diagnostics`、`/activity`、`/permissions`、`/system`、`/init [--force]`。
