...
- 新增命令：`/git [status|log]`、`/diff [--staged] [path]`、`/editor [initial text]`、`/diagnostics`、`/activity`、`/permissions`、`/system`、`/init [--force]`；headless 支持 `--show-permissions [--json]` 和 `--show-system-prompt [--json]`。
